...
def outcome():
    with gobal.con:
        if not session.get("name"):
            ...
            sql = """
                    SELECT roworder,bill_no, item_name, to_char(bill_date,'DD-MM-YYYY HH24:MI:SS') as bill_date, cash_kip, cash_baht, cash_dollar FROM public.tb_outcome order by roworder DESC
                  """
